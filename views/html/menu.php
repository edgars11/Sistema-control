...
$menu = new Menu();
$datos = $menu->getMenuPorRol("M", $_SESSION['rol_id']);
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                foreach ($datos as $row) {
                    if ($row["men_grupo"] == 'Dashboard' && $row["mend_permiso"] == 'S') {
                ?>
                        <li class="nav-item">
                ...
                <?php
                foreach ($datos as $row) {
                    if ($row["men_grupo"] == 'Mantenimiento' && $row["mend_permiso"] == 'S') {
                ?>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo $row["men_ruta"] ?>" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                                <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards"><?php echo $row["men_nombre"] ?></span>
                ...
                <?php
                foreach ($datos as $row) {
                    if ($row["men_grupo"] == 'Lote' && $row["mend_permiso"] == 'S') {
                ?>
                        <li class="nav-item">

                            <?php
                            if ($row["men_nombre"] == 'Registro Pedido') {
                            ?>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                                <i class="ri-layout-3-line"></i> <span data-key="t-layouts"><?php echo $row["men_nombre"] ?></span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarLayouts">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="../MovSalidaRegistroPV" class="nav-link" data-key="t-horizontal">Registro Pollo Vivo</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="../MovSalidaRegistroPF" class="nav-link" data-key="t-detached">Registro Pollo Faenado</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
            ...
            <!-- Cuentas -->
            <li class="menu-title"><span data-key="t-menu">Cuentas</span></li>
            <?php
            foreach ($datos as $row) {
                if ($row["men_grupo"] == 'Cuentas' && $row["mend_permiso"] == 'S') {
            ?>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="<?php echo $row["men_ruta"] ?>" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards"><?php echo $row["men_nombre"] ?></span>
