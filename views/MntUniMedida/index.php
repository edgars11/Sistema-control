...
$menu = new Menu();
$datos = $menu->validacionMenuRol($_SESSION["usu_id"], "mntUniMedida");
...
?>
        ...
        <body>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">Mantenimiento Unidad Medida</h4>

                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Unidad Medida</a></li>
            ...
            <script type="text/javascript" src="mntUniMedida.js"></script>
            <!-- Fin librerias js -->
        </body>
