                            ...
                            <div class="h-100">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                <h4 class="fs-16 mb-1">Buen día, <?php echo $_SESSION['usu_nombre']  ?>!</h4>
                                            ...
                                            <div class="mt-3 mt-lg-0">
                                                <form action="javascript:void(0);">
                                                    <div class="row g-3 mb-0 align-items-center">
                                                        ...
                                                        <!--end col-->
                                                        <div class="col-auto">
                                                            <a href="../MovSalidaLote" type="button" class="btn btn-soft-success"><i class="ri-add-circle-line align-middle me-1"></i> Registrar Salida</a>
                                                        </div>
                                                        <!--end col-->
                                                        <div class="col-auto">
                                                            <button type="button" class="btn btn-soft-info btn-icon waves-effect waves-light"><i class="ri-pulse-line"></i></button>
                                                        </div>
                                                        <!--end col-->
                                                    </div>
                                                    <!--end row-->
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        ...
                                                        <a href="../ListSalidaLote/" class="text-decoration-underline">Ver listado pedidos</a>
                                                    </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Pedidos</p>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">LIBRAS VENDIDAS</p>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <h5 class="text-success fs-14 mb-0">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        ...
                                                        <a href="../MntCliente/" class="text-decoration-underline">Ver listado</a>
                                                    </div>
                                                    <div class="avatar-sm flex-shrink-0">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">TOP 5 CLIENTES CON MÁS COMPRAS EN EL MES</h4>
                                            </div><!-- end card header -->
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card card-height-100">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">MOVIMIENTO LOTES</h4>
                                            </div><!-- end card header -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8">
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">SALIDAS RECIENTES</h4>
                                                <div class="flex-shrink-0">
