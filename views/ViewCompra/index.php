                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Vista Detalle Compra</h4>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="card-body p-4">
                                                    <div class="row g-3">
                                                        <div class="col-lg-3 col-6">
                                                            ...
                                                            <h5 class="fs-14 mb-0">#C-<span id="comp_id"></span></h5>
                                                        </div>
                                                        <!--end col-->
                                                        <div class="col-lg-3 col-6">
                                                            <p class="text-muted mb-2 text-uppercase fw-semibold">Fecha de compra</p>
                                                            <h5 class="fs-14 mb-0"><span id="comp_fecha_crea"></span></h5>
                                                        </div>
                                                        <!--end col-->
                                                        <div class="col-lg-3 col-6">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="card-body p-4 border-top border-top-dashed">
                                                    <div class="row g-3">
                                                        <div class="col-4">
                                                            <h6 class="text-muted text-uppercase fw-semibold mb-3">Nombre Proveedor</h6>
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <p class="fw-medium mb-2" id="mon_nombre"></p>
                                                        </div>
                                                        <!--end col-->
                                                    </div>
                                                    <!--end row-->
                                                    ...
                                                    <div class="border-top border-top-dashed mt-2">
                                                        <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
                                                            <tbody>
                                                                <tr>
                                                                    <td>Sub Total</td>
                                                                    <td class="text-end" id="comp_subtotal">$699.96</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Estimated Tax (12.5%)</td>
                                                                    <td class="text-end" id="comp_iva">$44.99</td>
                                                                </tr>
                                                                <tr class="border-top border-top-dashed fs-15">
                                                                    <th scope="row">Total Amount</th>
                                                                    <th class="text-end" id="comp_total">$755.96</th>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <!--end table-->
