    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="lbTitulo">Modal Sucursal</h5>
                    ...
                    <div class="row gy-2">
                        <div class="col-md-12">
                            <div>
                                ...
                                <input type="text" class="form-control" id="suc_nombre" name="suc_nombre" placeholder="Ingrese Nombre" required>
                            </div>
                        </div>
                    </div>
                </div>
