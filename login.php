...
<head>
    ...
    <meta charset="utf-8" />
    <title>Inicio Sesión | Fact-System</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Inicie sesión para ingresar a Fact-System</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form action="" method="post" id="login_form">
                                                ...
                                                <div class="mb-3">
                                                    <div class="float-end">
                                                        <a href="auth-pass-reset-cover.html" class="text-muted">Olvidé mi contraseña?</a>
                                                    </div>
